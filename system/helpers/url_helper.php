...
if (!function_exists('redirect'))
{
	...
	function redirect($uri = '', $method = 'auto', $code = NULL)
	{
		...
		elseif ($method !== 'refresh' && (empty($code) OR !is_numeric($code)))
		{
			...
			$code = (isset($_SERVER['REQUEST_METHOD'], $_SERVER['SERVER_PROTOCOL']) && $_SERVER['REQUEST_METHOD'] === 'POST' && $_SERVER['SERVER_PROTOCOL'] === 'HTTP/1.1') ? 303 : 302;
		}
