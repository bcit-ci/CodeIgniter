...
class CI_DB_pdo_dblib_driver extends CI_DB_pdo_driver
{
	...
	{
		return 'SELECT ' . $this->escape_identifiers('name') . ' FROM ' . $this->escape_identifiers('sysobjects') . ' WHERE ' . $this->escape_identifiers('type') . " = 'U'";
	...
	{
		return 'SELECT ' . $this->escape_identifiers('column_name') . ' FROM ' . $this->escape_identifiers('information_schema.columns') . ' WHERE ' . $this->escape_identifiers('table_name') . ' = ' . $this->escape($table);
	}
	...
	protected function _delete($table, $where = array(), $like = array(), $limit = FALSE)
	{
		...
		return ($limit) ? 'WITH ci_delete AS (SELECT TOP ' . $limit . ' * FROM ' . $table . $conditions . ') DELETE FROM ci_delete' : 'DELETE FROM ' . $table . $conditions;
	}
