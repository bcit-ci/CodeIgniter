...
class CI_DB_result {
	...
	public function result($type = 'object', $key = '')
	{
		...
		return $this->custom_result_object($type, $key);
	}
	 ...
	 */
	public function custom_result_object($class_name, $object_key = '')
	{
	 ...
	 *
	 * @param	string Name of field you want to use as the array's key
	 * @return	object
	 */
