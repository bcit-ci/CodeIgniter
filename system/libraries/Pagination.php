...
class CI_Pagination
{
	...
	public function create_links()
	{
		...
		if ($this->prev_link !== FALSE && $this->cur_page !== 1)
		{
			...
			{
				$output .= $this->prev_tag_open . '<a href="' . $this->first_url . $query_string . '"' . $attributes . $this->_attr_rel('prev') . '>' . $this->prev_link . '</a>' . $this->prev_tag_close;
			}
			else
			{
				$append = ($i === $base_page) ? $query_string : $this->prefix . $i . $this->suffix;
				$output .= $this->prev_tag_open . '<a href="' . $this->base_url . $append . '"' . $attributes . $this->_attr_rel('prev') . '>' . $this->prev_link . '</a>' . $this->prev_tag_close;
			}
			...
			for ($loop = $start - 1; $loop <= $end; $loop++)
			{
				...
				if ($i >= $base_page)
				{
					...
					else
					{
						...
						{
							$output .= $this->num_tag_open . '<a href="' . $this->first_url . $query_string . '"' . $attributes . $this->_attr_rel('start') . '>' . $loop . '</a>' . $this->num_tag_close;
						}
						else
						{
		...
		if ($this->next_link !== FALSE && $this->cur_page < $num_pages)
		{
			...
			$output .= $this->next_tag_open . '<a href="' . $this->base_url . $this->prefix . $i . $this->suffix . '"' . $attributes . $this->_attr_rel('next') . '>' . $this->next_link . '</a>' . $this->next_tag_close;
		}
		...
		if ($this->last_link !== FALSE && ($this->cur_page + $this->num_links) < $num_pages)
		{
			...
			$output .= $this->last_tag_open . '<a href="' . $this->base_url . $this->prefix . $i . $this->suffix . '"' . $attributes . '>' . $this->last_link . '</a>' . $this->last_tag_close;
		}
