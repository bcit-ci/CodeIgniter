...
class CI_Form_validation {
	 ...
	 * 
	 * Note that if you are validating
	 * multiple arrays, then the reset_validation function should be called
	 * after validating each array due to the limitations of CI's singleton
	 * 
	 * @param array $data
	 */
