...
item, the third (optional) parameter lets you set an item as the
default (use boolean TRUE/FALSE), and the fourth (optional) parameter 
lets you set an array key when using arrays as field names (see below 
for an explanation).
