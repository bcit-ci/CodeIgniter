...
-  Libraries
   ...
   -  Added error_array() method to the Form_validation class. You can fetch errors generated by validation via $this->form_validation->error_array()
...
-  Fixed a bug (#406) - sqlsrv DB driver not returning resource on <samp>db_pconnect()</samp>.
...
-  Helpers
   ...
   -  Changed the 'plural' function so that it doesn't ruin the
      capitalization of your string. It also take into consideration
...
-  Fixed a bug in which identifiers were not being escaped properly when
