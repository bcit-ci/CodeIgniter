...
-  Database
   ...
   -  An optional database name parameter was added to db_select().
   -  PostgreSQL driver now uses pg_version() for server version checking, when appropriate.
   -  PostgreSQL driver now supports db_set_charset() for setting client encoding.
