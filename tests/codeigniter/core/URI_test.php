...
class URI_test extends CI_TestCase {
	...
	public function test__fetch_uri_string()
	{
		...
		$a = 'controller/method';
		$b =& $this->uri->uri_string; // note: by reference
	...
	public function test_uri_string_slashes()
	{
		$this->uri->uri_string = 'controller/method';
		
		$slash_arr = array(
			'both' => '/controller/method/',
			'leading' => '/controller/method',
			'trailing' => 'controller/method/',
			'none' => 'controller/method',
			'asdf' => 'controller/method' // default
		);
		
		foreach($slash_arr as $where => $a)
		{
			$this->uri->config->set_item('uri_string_slashes', $where);
	...
	public function test_ruri_string_slashes()
	{
		$this->uri->rsegments = array('method', 'controller');
		
		$slash_arr = array(
			'both' => '/method/controller/',
			'leading' => '/method/controller',
			'trailing' => 'method/controller/',
			'none' => 'method/controller',
			'asdf' => 'method/controller' // default
		);
