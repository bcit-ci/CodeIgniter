...
class Session_test extends CI_TestCase
{
	...
	public function set_up()
	{
		...
		$obj = new stdClass;
		$classes = array('config' => 'cfg', 'load' => 'load', 'input' => 'in');
		...
		$config = array('sess_encrypt_cookie' => FALSE, 'sess_use_database' => FALSE, 'sess_table_name' => '', 'sess_expiration' => 7200, 'sess_expire_on_close' => FALSE, 'sess_match_ip' => FALSE, 'sess_match_useragent' => TRUE, 'sess_cookie_name' => 'ci_session', 'cookie_path' => '', 'cookie_domain' => '', 'cookie_secure' => FALSE, 'cookie_httponly' => FALSE, 'sess_time_to_update' => 300, 'time_reference' => 'local', 'cookie_prefix' => '', 'encryption_key' => 'foobar', 'sess_valid_drivers' => array('Mock_Libraries_Session_native', 'Mock_Libraries_Session_cookie'));
