...
<html lang="en">
	...
	<head>
		...
		<link href="dashboard/assets/vendors/custom/datatables/datatables.bundle.css" rel="stylesheet" type="text/css" />
		...
		<link href="dashboard/assets/css/demo1/style.bundle.css" rel="stylesheet" type="text/css" />
		<link href="dashboard/assets/css/demo1/skins/header/base/light.css" rel="stylesheet" type="text/css" />
		<link href="dashboard/assets/css/demo1/skins/header/menu/light.css" rel="stylesheet" type="text/css" />
		<link href="dashboard/assets/css/demo1/skins/brand/navy.css" rel="stylesheet" type="text/css" />
		<link href="dashboard/assets/css/demo1/skins/aside/navy.css" rel="stylesheet" type="text/css" />
		<link href="dashboard/mad.css" rel="stylesheet" type="text/css" />
	...
	<body class="kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--enabled kt-subheader--transparent kt-aside--enabled kt-aside--fixed kt-page--loading">
		...
		<div id="kt_header_mobile" class="kt-header-mobile  kt-header-mobile--fixed ">
			<div class="kt-header-mobile__logo">
				<a href="#">
					<img alt="Logo" src="dashboard/images/logo-inverse.png" />
				</a>
			</div>
		...
		<script src="dashboard/assets/js/demo1/scripts.bundle.js" type="text/javascript"></script>
		<script src="dashboard/assets/vendors/custom/datatables/datatables.bundle.js" type="text/javascript"></script>
		<script src="dashboard/assets/js/demo1/pages/crud/datatables/advanced/column-rendering.js" type="text/javascript"></script>
		<script>
