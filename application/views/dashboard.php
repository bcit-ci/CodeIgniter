...
<html lang="en">
	...
	<head>
		...
		<link href="admin/assets/vendors/general/toastr/build/toastr.css" rel="stylesheet" type="text/css" />
		...
		<link href="admin/assets/vendors/general/@fortawesome/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css" />
		...
		<link href="admin/assets/css/demo1/skins/brand/navy.css" rel="stylesheet" type="text/css" />
		<link href="admin/assets/css/demo1/skins/aside/navy.css" rel="stylesheet" type="text/css" />
		<link href="admin/mad.css" rel="stylesheet" type="text/css" />
	...
	<body class="kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--enabled kt-subheader--transparent kt-aside--enabled kt-aside--fixed kt-page--loading">
		...
		<div id="kt_header_mobile" class="kt-header-mobile  kt-header-mobile--fixed ">
			<div class="kt-header-mobile__logo">
				<a href="#">
					<img alt="Logo" src="admin/images/logo-inverse.png" />
				</a>
			</div>
		...
		<script src="admin/assets/vendors/custom/js/vendors/bootstrap-datepicker.init.js" type="text/javascript"></script>
		...
		<script src="admin/assets/vendors/custom/js/vendors/bootstrap-timepicker.init.js" type="text/javascript"></script>
		...
		<script src="admin/assets/vendors/custom/js/vendors/bootstrap-markdown.init.js" type="text/javascript"></script>
		...
		<script src="admin/assets/vendors/custom/js/vendors/jquery-validation.init.js" type="text/javascript"></script>
		<script src="admin/assets/vendors/general/toastr/build/toastr.min.js" type="text/javascript"></script>
		...
		<script src="admin/assets/vendors/custom/js/vendors/sweetalert2.init.js" type="text/javascript"></script>
		...
		<script src="admin/assets/js/demo1/pages/crud/datatables/advanced/column-rendering.js" type="text/javascript"></script>
		<script>
